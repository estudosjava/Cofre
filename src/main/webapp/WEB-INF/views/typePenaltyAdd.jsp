...
<form method="POST" commandName="typepenalty" action="${pageContext.request.contextPath}/typepenalty/addTypePenalty.html" class="form-horizontal" >
	<fieldset>			
		<div class="form-group">
 				...
 				<div class="col-lg-3">
   				<textarea id="description" placeholder="Insira a descrição" class="form-control"></textarea>
 				</div>
		</div>
		<div class="form-group">
 				<label class="col-lg-2 control-label" for="value">Valor:</label>
 				<div class="col-lg-3">
   				<input id="value" type="currency" placeholder="Insira o valor" class="form-control" />
 				</div>
		</div>			
		<div class="form-group">
