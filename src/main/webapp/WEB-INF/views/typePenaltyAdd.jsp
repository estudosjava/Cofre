...
<form:form method="POST" commandName="typepenalty" action="${pageContext.request.contextPath}/typepenalty/addTypePenalty.html" class="form-horizontal" >
	<fieldset>			
		...
		<div class="form-group">
 				...
 				<div class="col-lg-3">
   				<form:input path="value" type="currency" placeholder="Insira o valor" class="form-control" />
 				</div>
		</div>			
		<div class="form-group">
		  <label class="col-lg-1 control-label" for="cadastroTipoMulta"></label>
			  <div class="col-lg-1 control-label">
			    <input type="submit" id="addTypePenalty" value="Cadastrar" name="addTypePenalty" class="btn btn-default"/>
			  </div>
		</div>
	</fieldset>
</form:form>				
